...
For working examples of using the Replay Protocol directly, see the [Protocol Examples repository](https://github.com/Replayio/Protocol-Examples) on GitHub. It includes examples for common tasks like fetching network data, querying console messages, and more.

Here's a quick taste — fetching network request data from a recording:
