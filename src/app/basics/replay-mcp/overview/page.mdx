...
Before using Replay MCP, you need a recording to inspect. See [How to Record](/basics/getting-started/record-your-app) for the three ways to create one: Replay Browser + CLI, Chrome Extension, or Playwright/E2E in CI.
</Callout>
