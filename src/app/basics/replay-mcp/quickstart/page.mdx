...
This quickstart uses an agent-driven CLI recording. You can also record with the [Chrome Extension](/basics/replay-chrome-extension/getting-started) or [Playwright in CI](/basics/getting-started/record-your-playwright-tests). See [How to Record](/basics/getting-started/record-your-app) for a comparison of all methods.
</Callout>
