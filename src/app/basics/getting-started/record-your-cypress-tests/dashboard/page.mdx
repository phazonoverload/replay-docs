...
Clicking on any test file will take you into Replay DevTools, where you can start debugging your test execution using the [Cypress panel](/basics/getting-started/record-your-cypress-tests).
...
- [Cypress panel with Replay DevTools](/basics/getting-started/record-your-cypress-tests)
- [Debugging tips](/basics/getting-started/record-your-cypress-tests/debugging-tests)
- [Continuous integration](/basics/getting-started/record-your-cypress-tests/other-ci-providers)
