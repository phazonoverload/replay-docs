...
Fortunately, you can set this manually on the command line or in your CI configuration. Follow the [instructions for running with earlier versions of Cypress](/basics/getting-started/record-your-cypress-tests/faq) to configure `RECORD_REPLAY_METADATA_FILE`
...
For more information, see [Diagnostic modes](/basics/getting-started/record-your-cypress-tests)
