...
We have created an extra tooling around the most popular ones today - [Cypress.io](/basics/getting-started/record-your-cypress-tests) and [Playwright](/basics/getting-started/record-your-playwright-tests).
