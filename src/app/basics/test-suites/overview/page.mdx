...
Whether you use Playwright or other test runners, you simply swap your current browser with **Replay Browser** and that’s it:
...
Replay Devtools work great with your existing test suite. The Playwright plugin lets you **rewind or fast forward** to any command from your test run.
...
We have created extra tooling around popular frameworks—see the [Playwright guide](/basics/getting-started/record-your-playwright-tests) to get started.
