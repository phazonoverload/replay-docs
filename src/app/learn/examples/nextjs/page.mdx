...
For examples on how to record your tests on a CI pipeline, check out [reference docs](/basics/getting-started/record-your-playwright-tests/github-actions) or examples on how to record a [Vercel preview deployment](/learn/examples/vercel).
