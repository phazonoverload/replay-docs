...
const variantStyles = {
  primary:
    'rounded-full text-white py-2 px-4 text-sm font-semibold text-gray-900 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-500/50 active:bg-pink-500 transition-all',
  secondary:
